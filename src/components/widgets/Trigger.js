...
const Trigger = (props) => {
	...
	console.log("Trigger.isLoggedIn: ",isLoggedIn);
			...
			>
				{isLoggedIn ?
					<img id="trgr-img"
						...
						alt=""
					/>
				: <svg className="h-6 w-6 inline-flex items-center fill-current text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
