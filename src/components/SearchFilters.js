...
const SearchFilters = () => {
	...
	return (
		...
		<div className="flex justify-between px-4 py-3 xl:hidden">
			...
			<button
				type="button"
				className={`ml-4 inline-flex items-center hover:bg-gray-500 focus:ring-4 focus:ring-offset-blue-200 rounded-lg shadow pl-3 pr-4 ${isOpen ? "bg-gray-600" : "bg-gray-700"}`}
				onClick={toggle}
			>
				<svg
